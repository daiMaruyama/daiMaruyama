...
28卒の学生エンジニアです。現在は **Unity (C#)** を用いたゲーム開発に没頭しています。
単に機能を作るだけでなく、**「プレイヤーが心地よいと感じるUX」** をコードレベルから追求することに情熱を持っています。

将来は、**確固たる設計思想を持ちつつ、チーム全体の開発効率や品質を底上げできるエンジニア** を目指しています。

- 🌱 現在の学習テーマ: デザインパターン
- 💬 Ask me about: Unity, Game Mechanics
